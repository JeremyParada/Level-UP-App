...
class AddressScreenTest {
    ...
    fun clicking_edit_button_shows_edit_dialog_prefilled() {
        ...
        // Find Edit button for first item (AddressManagementItem uses Icon with null
        // contentDescription)
        ...
        // Since "Av. Siempre Viva" is the first item in logic usually (LazyColumn order matches
        // list)
